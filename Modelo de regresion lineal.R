...
# ___________ Modelo de Regresion lineal simple _______
...
MRL<-ggplot(gentoo, aes(x=masa_corporal_g, y=largo_pico_mm))+
  geom_point()+
  geom_smooth(method = "lm", formula=y~x, col="maroon4")+
  ggtitle("Modelo de Regresion Lineal Simple")+
...
#------------------------------------
#  Calculo y representacion de la recta
